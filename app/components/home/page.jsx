...
const HomePage = () => {
  return (
    ...
    <div className="w-screen bg-customhome bg-fixed bg-no-repeat bg-cover bg-center">
      ...
      <div className="flex flex-col items-center w-full h-[30rem] border-t-4 border-white mx-auto px-2 py-4 bg-gray-950 bg-opacity-60 overflow-y-auto">
        <h1 className="text-xl text-white tracking-wider uppercase font-semibold">
